...
Wn.WizardItem.extend('Podcast.Wizard', {
	nameField: undefined,
	urlField: undefined,
	...
	constructor: function(config) {
		...
		vbox.append(new Ui.Label({ text: 'URL du flux RSS du Podcast:', horizontalAlign: 'left' }));
...
Wn.ResourceWizard.register('podcast', 'Podcast', 'note', [ Podcast.Wizard ], Podcast.Creator);
