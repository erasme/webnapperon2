...
Ui.CanvasElement.extend('Wn.PosButton', {}, {
...
Ui.CanvasElement.extend('Wn.PosBar', {
	currentPos: 0,
	loadPos: 0,
...
Ui.Container.extend('Wn.MediaProgressBar', {
	posButton: undefined,
	posBar: undefined,
	pos: 0,
	...
	constructor: function(config) {
		...
		this.posBar = new Wn.PosBar({ verticalAlign: 'center' });
		this.appendChild(this.posBar);

		var button = new Wn.PosButton({ margin: 10 });
...
Ui.CanvasElement.extend('Wn.PlayButton', {
	mode: 'play',
	clock: undefined,
...
Ui.LBox.extend('Wn.MediaPlayBar', {
	bg: undefined,
	media: undefined,
...
//		this.append(new Ui.Rectangle({ fill: '#eff1f1', margin: 0, radius: 0 }));
		...
		this.playButton = new Wn.PlayButton({ mode: 'play', backgroundVisible: false, width: 60, height: 60 });
		...
		// pos bar here
		this.progressBar = new Wn.MediaProgressBar({ height: 30, verticalAlign: 'center' });
...
Ui.LBox.extend('Wn.AudioPlayer', {
	...
	constructor: function(config) {
		...
		this.playButton = new Wn.PlayButton({ mode: 'play', width: 80, height: 80 });
		pressable.setContent(this.playButton);
		this.append(pressable);

		this.mediaBar = new Wn.MediaPlayBar({ media: this.media, verticalAlign: 'bottom'/*, marginBottom: 20, marginLeft: 20, marginRight: 20*/ });
